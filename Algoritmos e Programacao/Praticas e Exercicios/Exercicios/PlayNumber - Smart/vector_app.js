...
import { getIndexVector, removeFromVector, addToVector } from './vector_utils.js'
...
function main(){
    ...
    while(true){
        if(option === 1){
            ...
            if(decision != 0){
                ...
                if(decision == 1){
                    ...
                    for(let index = 0; index < length; index++){
                        ...
                        vector = addToVector(number, vector)
                    }
                }
                else if(decision == 2){
                    const parameters = getVectorParameters()
            ...
            const summation = toReduce(vector, (accumulator, current)=>{accumulator+current}, 0)
            ...
            const positiveVector = toFilter(vector, (item)=>{return item > 0})
            ...
            let negativeVector = toFilter(vector, (item)=>{return item < 0})
            ...
            vector = addToVector(newNumber, vector)
